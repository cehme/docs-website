...
<Callout variant="tip">
  ...
  The JP data center is not supported by this API. [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/) is the only supported API to query New Relic data using [JP region endpoints](/docs/accounts/accounts-billing/account-setup/choose-your-data-center/).
</Callout>
